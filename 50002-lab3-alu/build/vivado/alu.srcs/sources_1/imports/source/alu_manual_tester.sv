...
module alu_manual_tester (
    ...
    localparam _MP_SIZE_1817518420 = 6'h20;
    logic [31:0] M_alu_a;
    logic [31:0] M_alu_b;
    ...
    localparam E_States_IDLE = 3'h5;
    localparam SIZE = 6'h20;
    localparam SEVEN_SEG_DIV = 5'h10;
    localparam CLK_FREQ = 24'h989680;
    localparam logic [4:0][0:0] _MP_RISE_794567137 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_794567137 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    logic [4:0] M_io_button_edge_clk = {3'h5{clk}};
    
    genvar idx_0_794567137;
    
    generate
        for (idx_0_794567137 = 0; idx_0_794567137 < 5; idx_0_794567137 = idx_0_794567137 + 1) begin: forLoop_idx_0_794567137
            edge_detector #(
                .RISE(_MP_RISE_794567137[idx_0_794567137]),
                .FALL(_MP_FALL_794567137[idx_0_794567137])
            ) io_button_edge (
                .clk(M_io_button_edge_clk[idx_0_794567137]),
                .in(M_io_button_edge_in[idx_0_794567137]),
                .out(M_io_button_edge_out[idx_0_794567137])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][23:0] _MP_CLK_FREQ_463761415 = {{24'h989680, 24'h989680, 24'h989680, 24'h989680, 24'h989680}};
    localparam _MP_MIN_DELAY_463761415 = 5'h14;
    localparam _MP_NUM_SYNC_463761415 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    logic [4:0] M_io_button_cond_clk = {3'h5{clk}};
    
    genvar idx_0_463761415;
    
    generate
        for (idx_0_463761415 = 0; idx_0_463761415 < 5; idx_0_463761415 = idx_0_463761415 + 1) begin: forLoop_idx_0_463761415
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_463761415[idx_0_463761415]),
                .MIN_DELAY(_MP_MIN_DELAY_463761415),
                .NUM_SYNC(_MP_NUM_SYNC_463761415)
            ) io_button_cond (
                .clk(M_io_button_cond_clk[idx_0_463761415]),
                .in(M_io_button_cond_in[idx_0_463761415]),
                .out(M_io_button_cond_out[idx_0_463761415])
            );
        end
    endgenerate
    
    
    localparam _MP_DIGITS_293991218 = 3'h4;
    localparam _MP_DIV_293991218 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_293991218),
        .DIV(_MP_DIV_293991218)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
    ...
    always @* begin
        ...
        case (M_alu_z)
            1'h0: begin
                D_current_value_d[2'h2] = 1'h0;
                D_current_value_d[3'h5] = 1'h0;
                D_current_value_d[3'h6] = 1'h0;
            end
            1'h1: begin
        ...
        case (M_alu_v)
            1'h0: begin
                D_current_value_d[1'h1] = 1'h0;
                D_current_value_d[2'h3] = 1'h0;
            end
            1'h1: begin
